...
※ キットに含まれる内容がMX用トッププレート固定穴1つ分の、3.5mmスペーサー、4.0mmネジ(黒)、5.0mmネジ(銀)が少ない内容になっておりました。大変申し訳ありません。購入された方に追加の部品を送らせていただいています。74th.tech@gmail.com まで連絡いただきますようお願い致します。
